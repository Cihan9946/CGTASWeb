...
@section('js')
    ...
    <script>
        ...
        let packageTable = $('#subMenuTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('FooterfetchPageSubMenu', $submenu -> id) !!}',
            columns: [
                {data: 'id'},
                {data: 'title'},
                {data: 'detail'},
        ...
        function create_p(){
            Swal.fire({
                ...
                if (result.isConfirmed){
                    let url = '{{route('FooterpageSubMenuCreate')}}';
        ...
        function delete_smp(id){
            Swal.fire({
                ...
                if (response.isConfirmed){
                    $.ajax({
                        url:'{{route('FooterdeletePageSubMenu')}}',
                        type:'POST',
                        data: {
                            id:id,
                            "_token":'{{csrf_token()}}'
        ...
        function update_pageSubMenu(){
            ...
            $.ajax({
                url:'{{route('FooterupdatePageSubMenu')}}',
                type:'POST',
                data: {
        ...
        function openPageSubMenuUpdate(id){
            ...
            $.ajax({
                url:'{{route('FootergetPageSubMenu')}}',
                type:'GET',
                data: {
                    id:id
                },

...
@section('js')
    ...
    <script>
        ...
        let packageTable = $('#pageMenuTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('FooterfetchPageMenu', $menu -> id) !!}',
            columns: [
                {data: 'id'},
                {data: 'title'},
                {data: 'detail'},
        ...
        function create_p(){
            Swal.fire({
                ...
                if (result.isConfirmed){
                    let url = '{{route('FooterpageMenuCreate')}}';
        ...
        function delete_pm(id){
            Swal.fire({
                ...
                if (response.isConfirmed){
                    $.ajax({
                        url:'{{route('FooterdeletePageMenu')}}',
                        type:'POST',
                        data: {
                            id:id,
                            "_token":'{{csrf_token()}}'
        ...
        function update_pageMenu(){
            ...
            $.ajax({
                url:'{{route('FooterupdatePageMenu')}}',
                type:'POST',
                data: {

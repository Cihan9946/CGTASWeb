...
@section('content')
    ...
    <div class="page-heading">
        <h3>Footer Menü ve Alt Menüler</h3>
    </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="form-group">
                        <p> Footer Menü eklemek için aşağıdaki butonu kullanınız.</p>
    ...
    <script>
        ...
        function create_sm(){
            Swal.fire({
                ...
                if (result.isConfirmed){
                    let url = '{{route('FootersubMenuCreate')}}';
        ...
        function update_menu(){
            ...
            $.ajax({
                ...
                success:()=>{
                    ...
                    document.getElementById('FooterupdateName').value = '';
                },
                error:()=>{
                    Swal.fire({
                        icon:'error',
